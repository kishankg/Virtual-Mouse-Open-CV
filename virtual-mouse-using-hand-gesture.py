...
# last arguementcv2.createTrackbar() function
def nothing(x):
	pass
...
#This function is just used to look better
...
# Contours on the mask are detected and centroid of the largest of these is drawn and returned 
